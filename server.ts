namespace IcecreamShop {
    ...
    drawIce(){
        ...
        crc2.fillStyle = "#d4d4d4";
        crc2.beginPath();
        crc2.arc(this.position.x + 85, this.position.y -3 + 5, 35, Math.PI, 2 * Math.PI);
        crc2.fill();
        crc2.closePath();
        crc2.beginPath();
        crc2.fillStyle = "#c2c1c0";
        crc2.arc(this.position.x + 85, this.position.y -40 + 5, 5, 0, 2 * Math.PI);
        crc2.fill();
        crc2.closePath();
    }
 }
